 ...
 */
                           ...
                           public  java.lang.String[] getUserlist(){
                              ...
                              */
                              public void setUserlist(java.lang.String[] param){
                               ...
                               localUserlistTracker = param != null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GroupInfoResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GroupInfoResponse",
    ...
    public static class Factory{
        ...
        */
        public static GroupInfoResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GroupInfoResponse object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GroupInfoResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GroupInfoResponse)localhost.userservice_xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("","userlist").equals(reader.getName())){
                                                         list1.add(reader.getElementText());

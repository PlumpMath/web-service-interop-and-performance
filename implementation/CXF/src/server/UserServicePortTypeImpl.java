...
public class UserServicePortTypeImpl implements UserServicePortType {
	...
	private final CopyOnWriteArrayList<Group> groups = new CopyOnWriteArrayList<Group>();
	...
	public UserInfo getUserInfo(UserInfoRequest body) {
		// Find corresponding user and return information.
		User user = getUser(body.getUsername());
		if (user == null) {
			// No matching user found - return empty response.
